...
| Health Check API | [`core/views.py`](core/views.py) → `health_check()` (`GET /api/health/`) |
| Automated log pruning | [`core/management/commands/prune_logs.py`](core/management/commands/prune_logs.py) |
