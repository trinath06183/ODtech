...
def start():
    ...
    # Clean up obsolete morning_digest_job from persistent store if present
    try:
        _scheduler.remove_job("morning_digest_job")
    except Exception:
        pass
    ...
    try:
        ...
        logger.info(
            ...
            f"FY rollover on Apr 1 00:01 {timezone_str}."
        )
    except Exception as exc:
